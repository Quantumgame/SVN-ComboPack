...
if strcmp(stimulus.soundType, 'phonemeWavRR') %files specified in getClip-just need to indicate sad/dad
    %this code works for no laser condition - below for laser
...
if strcmp(stimulus.soundType, 'toneThenPhonemeRR')
    ...
    if lefts>=rights %choose a left stim (wav1)
        details.toneFreq = tones(1);
        freqCon = [0, duration]; %flipped for RR
    elseif rights>lefts %choose a right stim (wav2)
        details.toneFreq = tones(2);
        freqCon = [1, duration]; %flipped for RR
    end
end
...
if strcmp(stimulus.soundType, 'phoneToneConorRR') 
...
switch stimulus.soundType
    ...
    case {'toneThenPhonemeRR'}
        sSound = soundClip('stimSoundBase','toneThenPhonemeRR', [details.toneFreq]);
    case {'phoneToneConor'}
        sSound = soundClip('stimSoundBase','phoneToneConor', [details.toneFreq]);
    case {'phoneToneConorRR'}
        sSound = soundClip('stimSoundBase','phoneToneConorRR', [details.toneFreq]);
    case {'phonemeWavLaser'}
    ...
    case {'phonemeWavRR'} %%%shit shit shit shit
        sSound = soundClip('stimSoundBase','phonemeWavRR', [details.toneFreq]);
    case {'tone'}
