function s=toneDiscrimLCycle(varargin)
...
switch nargin
    case 0
        ...
        s = class(s,'toneDiscrimLCycle',stimManager());
    case 1
        % if single argument of this class type, return it
        if (isa(varargin{1},'toneDiscrimLCycle'))
            s = varargin{1};
        else
    ...
    case 6
        ...
        s = class(s,'toneDiscrimLCycle',stimManager(varargin{3},varargin{4},varargin{5},varargin{6}));
