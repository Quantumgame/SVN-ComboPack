...
if isempty(nAFCindex) || (~isempty(nAFCindex) && ~all([basicRecords.trialManagerClass]==nAFCindex))
    ...
    try
        ...
        [out.LaserTurnON newLUT] = extractFieldAndEnsure(stimDetails,{'LaserTurnON'},'scalar',newLUT);
        [out.LaserTurnOFF newLUT] = extractFieldAndEnsure(stimDetails,{'LaserTurnOFF'},'scalar',newLUT);
