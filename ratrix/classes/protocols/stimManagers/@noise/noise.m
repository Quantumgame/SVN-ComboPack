...
switch nargin
    case 0
        ...
        s = class(s,'noise',stimManager());
    case 1
        % if single argument of this class type, return it
        if (isa(varargin{1},'noise'))
            s = varargin{1};
        else
    ...
    case 6
        ...
        switch s.soundType
            case 'noise'
            otherwise
                error('noise: soundType not recognized')
        end
        s = class(s,'noise',stimManager(varargin{3},varargin{4},varargin{5},varargin{6}));
