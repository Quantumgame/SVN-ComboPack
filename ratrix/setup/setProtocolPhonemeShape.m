function r = setProtocolPhonemeShape(r,subjIDs)
...
% Make Stimuli - Tones
toneParams.soundType  = 'toneThenPhoneme'; %Need to calc phone at same time as freq
toneParams.freq       = [];
toneParams.duration   = 500;
toneParams.amp        = amplitude;

% Make Stimuli - Tones & Speech
phTParams.soundType   = 'phoneToneConor';
phTParams.freq        = [];
phTParams.duration    = 1000;
phTParams.amp         = amplitude;

%Phoneme Params
phPParams.soundType   = 'phonemeWav';
phPParams.freq        = [];
