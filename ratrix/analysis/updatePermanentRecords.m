function updatePermanentRecords()
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
datadir = input('\nWhere should we put/look for existing compiled records?\n    >','s');
recordsdir = input('\nWhere should we look for permanent records? (1 if we have network access to the rigs)\n    >','s');
