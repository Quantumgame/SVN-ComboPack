function updatePermanentRecordsSilent_linux()
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:length(mouseList)
    if ~all(cellfun('isempty',strfind(fileList,mouseList{i})))
        ...
        if strcmp(recordsdir,'1')
            cleanPermanentRecords(mouseList{i},['/mnt/rat',num2str(rigNums(i)),'/nlab/Desktop/laserData/PermanentTrialRecordStore/',mouseList{i}],datadir);
        else
