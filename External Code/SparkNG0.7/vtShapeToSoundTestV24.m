function varargout = vtShapeToSoundTestV24(varargin)
% VTSHAPETOSOUNDTESTV24 MATLAB code for vtShapeToSoundTestV24.fig
%      VTSHAPETOSOUNDTESTV24, by itself, creates a new VTSHAPETOSOUNDTESTV24 or raises the existing
%      singleton*.
%
%      H = VTSHAPETOSOUNDTESTV24 returns the handle to a new VTSHAPETOSOUNDTESTV24 or the handle to
%      the existing singleton*.
%
%      VTSHAPETOSOUNDTESTV24('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VTSHAPETOSOUNDTESTV24.M with the given input arguments.
%
%      VTSHAPETOSOUNDTESTV24('Property','Value',...) creates a new VTSHAPETOSOUNDTESTV24 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vtShapeToSoundTestV24_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vtShapeToSoundTestV24_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vtShapeToSoundTestV24

% Last Modified by GUIDE v2.5 24-Aug-2015 04:34:21

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @vtShapeToSoundTestV24_OpeningFcn, ...
    'gui_OutputFcn',  @vtShapeToSoundTestV24_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before vtShapeToSoundTestV24 is made visible.
function vtShapeToSoundTestV24_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vtShapeToSoundTestV24 (see VARARGIN)

% Choose default command line output for vtShapeToSoundTestV24
...
% UIWAIT makes vtShapeToSoundTestV24 wait for user response (see UIRESUME)
% uiwait(handles.vtTester);


% --- Outputs from this function are returned to the command line.
function varargout = vtShapeToSoundTestV24_OutputFcn(hObject, eventdata, handles)
...
set(ax(1),'xlim',[0 5000],'ylim',maxGain+[-60 5]);
set(ax(1),'fontsize',13,'ytick',-60:10:60,'xgrid','on','ygrid','on');
...
set(handles.gainPlotHandle,'ydata',gaindB);
maxGain = max(gaindB(fx<5000));
set(handles.gainPlot,'ylim',maxGain+[-60 5]);
...
noteIndex = round(log2(handles.F0/55)*12+3);
if handles.F0 == 125
    set(handles.noteNamePopup,'value',1);
elseif handles.F0 == 250
