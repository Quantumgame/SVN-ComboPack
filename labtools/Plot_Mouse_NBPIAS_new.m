function Plot_Mouse_NBPIAS_new(expdate1,session1,filenum1 )

%Similar to the rat "PlotASRMike1(expdate,session,filenum )"...
%... and revised version of Plot_Mouse_NBPPI
%Revised 6-2-8 & updated 9-12-8 by MAK
