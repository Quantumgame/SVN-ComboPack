function PlotTC_trials(varargin)
%
%plots individual trials for a tuning curve
%usage:
%PlotTC_trials(expdate, session, filename)
%PlotTC_trials(expdate, session, filename, xlimits)
%PlotTC_trials(expdate, session, filename, xlimits, ylimits)
...
for i=1:length(event)
    if strcmp(event(i).Type, '2tone') |strcmp(event(i).Type, 'tone')|strcmp(event(i).Type, 'grating') | strcmp(event(i).Type, 'whitenoise') | strcmp(event(i).Type, 'fmtone')
        j=j+1;
...
j=0;
for i=1:length(event)
    if strcmp(event(i).Type, '2tone') | strcmp(event(i).Type, 'tone') | strcmp(event(i).Type, 'whitenoise') | strcmp(event(i).Type, 'fmtone') | strcmp(event(i).Type, 'grating')
