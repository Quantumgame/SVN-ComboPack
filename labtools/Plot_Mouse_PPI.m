function [p,m1,m2,percentNBPIAS,numprepulseamps,nreps1,M1,startle_start,samprate,window_duration,prepulse_start,baseline_start,prepulseamps,expdate1,session1,filenum1]=...
    Plot_Mouse_PPI(expdate1,session1,filenum1 )
global pref
if isempty(pref) Prefs; end

% Plot_Mouse_PPI.m
%   Last updated 9-26-8 at 4:45PM by Michael
% Variables here are exported to PlotMultiMousePPI.m which calls PlotMultiPPI.m
